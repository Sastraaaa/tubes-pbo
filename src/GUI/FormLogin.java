...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Fruitters.png"))); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtusername, javax.swing.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
      if((txtusername.getText().compareTo("admin")==0)&&(txtpassword.getText().compareTo("admin")==0)) {
            JOptionPane.showMessageDialog(rootPane,"Login Berhasil..\n Welcome User  "+txtusername.getText()+"");
            new HalamanUtama().show();
        }
        else
        {
            JOptionPane.showMessageDialog(rootPane,"Username Dan Password And Salah");
        }
