...
public class FormTransaction extends javax.swing.JFrame {
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        koneksidatabase();
    try {
        sql="update tbl_transaksibuah set no_transaksi='"+txtnotransaksi.getText()
        +"',tgl_transaksi='"+tgl
        +"',nama='"+txtnama.getText()
        +"',kode_buah'"+cmbkode.getSelectedItem()
        +"',nama_buah=+'"+txtnamabuah.getText()
        +"',harga_buah'"+txthargabuah.getText()
        +"'jumlah_beli'"+txtjumlah.getText()
        +"'total_bayar'"+txttotal.getText()
        +"'where no_tranasaksi='"+txtnotransaksi.getText()+"'";
        stat.execute(sql);
    ...
    private void btnbatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbatalActionPerformed
        koneksidatabase();
    try {
        sql = "delete from tbl transaksibuah where no_transaksi='"+txtnotransaksi.getText()+"'";
        stat = con.createStatement();
        stat.execute(sql);
        JOptionPane.showMessageDialog(null,"Data Berhasil Dihapus!");
    } catch (Exception e){
