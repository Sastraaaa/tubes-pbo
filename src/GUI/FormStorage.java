...
public class FormStorage extends javax.swing.JFrame {
    ...
    private void txtcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcariActionPerformed
        ...
        try {
            String sql = "SELECT nama_buah, kode_buah, harga_buah, kuantitas, berat_buah FROM tbl_storage WHERE nama_buah LIKE '%" + cari + "%'";
    ...
    String nama_buah = txtnamabuah.getText();
        String kode_buah = txtkode.getText();
        ...
        try {
            String sql = "INSERT INTO tbl_storage (nama_buah, kode_buah, harga_buah, kuantitas, berat_buah) VALUES (?, ?, ?, ?, ?)";
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setString(1, nama_buah);
            ps.setString(2, kode_buah);
